...
This covers **function parameters**, not method receivers (see `.claude/rules/002-go-conventions.md` §3 (consumer-side interfaces) and §6 (pointer vs value) for receiver rules).
...
-> See `.claude/rules/002-go-conventions.md` §3 (consumer-side interfaces) and §6 (pointer vs value) for pointer vs value **receiver** rules.
